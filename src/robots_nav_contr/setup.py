...
setup(
    ...
    entry_points={
        ...
        'console_scripts': [
            ...
            "octavia_commands = robots_nav_contr.octavia_commands_Receiver:main", # This is the robots command subscriber. Used on octavia
            "octavia_main = robots_nav_contr.octavia_MainRoutine:main", # This is the robots main routine. Used on octavia
